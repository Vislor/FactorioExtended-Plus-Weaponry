...
turret2.graphics_set.base_visualisation.animation.layers[1].filename = "__FactorioExtended-Plus-Weaponry__/graphics/entity/laser-turret-mk2/laser-turret-base-mk2.png"
